...
module.exports = (config) => {
    ...
    router.post('/cantidadRecibo', async (req, res) => {
        ...
        try {
            ...
            for (let i = 0; i < folios.length; i++) {
                ...
                if (result.recordset.length > 0) {
                    const updateQuery = `
                        UPDATE Codigos 
                        SET [Cantidad Recibida] = @cantidad, [Usuario Recibe] = @nomina, [Orden de Compra] = @OrdenCompra, [Numero de Parte] = @numeroParte
                    ...
                    const insertQuery = `
                        INSERT INTO Codigos (Folio, [Orden de Compra], [Numero de Parte], [Cantidad Recibida], [Usuario Recibe]) 
